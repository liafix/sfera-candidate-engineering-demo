...
Write-Host '=== SFERA Candidate Demo - Phase 5.1 verification ==='
...
Write-Host '[11/11] Phase 5.1 source contract checks'
...
Write-Host 'PHASE 5.1 BUILD GATE: PASS' -ForegroundColor Green
